...
use InstanceManager\AWS\Responses\DescribeResponse;
use InstanceManager\AWS\Responses\TerminateResponse;
use InstanceManager\BaseAdapter;
use InstanceManager\AWS\Responses\CreateResponse;
